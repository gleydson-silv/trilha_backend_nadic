...
from ..serializers import RegisterSerializer, normalize_serializer_errors
...
def forgot_password(request):
    ...
    try:
        ...
        return error_response(
            "Usuário não encontrado", status_code=status.HTTP_404_NOT_FOUND
        )
...
def reset_password(request, uidb64, token):
    ...
    try:
        ...
        return error_response(
            "Usuario não encontrado", status_code=status.HTTP_404_NOT_FOUND
        )
